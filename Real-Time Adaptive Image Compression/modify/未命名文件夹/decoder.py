...
class Decoder(nn.Module):
    ...
    def build(self, c):
        ...
        self.g.append(self._deconv_layer(channels, c[0], 6, 4, 1, k=0.2))
        self.g.append(self._deconv_layer(channels, c[1], 4, 2, 1, k=0.2))
        ...
        for i in range(0, 3):
            f1 = self._deconv_layer(c[i], 3, 4, 2, 1)
